...
The longest movie in this data set is the 'Cure for Insomnia' with a run time of 5220 minutes. The oldest movie in this data set is 'Blacksmith Scene' filmed in 1893.
...
My favorite movie 'Kiki's Delivery Service' is not included in this data set, potentially because it was originally a foreign film. 

You could answer questions like what is the highest budget film in each genre, what is the lowest rated Drama film with a budget above one million, or what is the film with the largest number of votes on IMDB with a rating below 3.0.
